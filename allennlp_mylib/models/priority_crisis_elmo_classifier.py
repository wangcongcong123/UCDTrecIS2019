'''
this class is adapted from https://github.com/allenai/allennlp/blob/master/allennlp/models/biattentive_classification_network.py
'''
...
from allennlp.modules import Elmo, FeedForward, Maxout, Seq2SeqEncoder, TextFieldEmbedder, Seq2VecEncoder
...
@Model.register("priority_crisis_elmo_classifier")
class PriorityCrisisELmoClassifier(Model):
    """
    ...
    def __init__(self,
        ...
        super(PriorityCrisisELmoClassifier, self).__init__(vocab, regularizer)
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'PriorityCrisisELmoClassifier':  # type: ignore
        # pylint: disable=arguments-differ
