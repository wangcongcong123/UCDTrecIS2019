...
@Model.register("priority_crisis_lossweight_classifier")
class PriorityCrisisClassifierWithLossWeight(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(PriorityCrisisClassifierWithLossWeight, self).__init__(vocab, regularizer)
        ...
        weights = torch.tensor([1.0000, 6.1094, 8.3922, 16.8462], dtype=torch.float32)
