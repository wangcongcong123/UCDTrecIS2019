...
@Model.register("category_crisis_elmo_classifier")
class CategoryCrisisELmoClassifier(Model):
    """
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'CategoryCrisisELmoClassifier':  # type: ignore
        # pylint: disable=arguments-differ
